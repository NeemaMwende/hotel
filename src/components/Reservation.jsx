      ...
      <div className="form reservation-form bg-black-10">
        ...
        <form action="" className="form-left">
          ...
          <p className="form-text text-center">
            Booking request <a href="tel:+254123123456" className="link">+254-123-123456</a>
        ...
        <div className="form-right text-center" style={{backgroundImage:('../Images/form-pattern.png')}}>
          ...
          <a href="tel:+254123123456" className="body-1 contact-number hover-underline">+254-123-123456</a>
